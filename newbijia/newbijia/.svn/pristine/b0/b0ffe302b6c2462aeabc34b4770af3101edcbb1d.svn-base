 ...
 * {@link GridViewWithHeaderAndFooter#addHeaderView(View, Object, boolean)}
 */
public class GridViewWithHeaderAndFooter extends GridView {
	...
	private static class HeaderViewGridAdapter implements WrapperListAdapter,
		...
		private int getAdapterAndPlaceHolderCount() {
			final int adapterCount = (int) (Math.ceil(1f * mAdapter.getCount()
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (mAdapter != null) {
				...
				if (adjPosition < adapterCount) {
					if (adjPosition < mAdapter.getCount()) {
						View view = mAdapter.getView(adjPosition, convertView,
								parent);
						view.setVisibility(VISIBLE);
						return view;
					} else {
						int lastPos = mAdapter.getCount() - 1;
						View view = mAdapter.getView(lastPos, convertView,
								parent);
						if (convertView == null) {
							convertView = new View(parent.getContext());
						}
