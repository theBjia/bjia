...
public class AddressBookActivity extends BaseActivity implements
	...
	private boolean showone = true, showtwo = true, showthree = true;
	...
	public void onClick(View v) {
		...
		case R.id.tv_one:
			if (showone) {
				mlv_no_add.setVisibility(View.GONE);
				showone = false;
			} else {
				mlv_no_add.setVisibility(View.VISIBLE);
				showone = true;
			}
			break;
		case R.id.tv_two:
			if (showtwo) {
				mlv_no_kaitong.setVisibility(View.GONE);
				showtwo = false;
			} else {
				mlv_no_kaitong.setVisibility(View.VISIBLE);
				showtwo = true;
			}
			break;
		case R.id.tv_three:
			if (showthree) {
				mlv_add.setVisibility(View.GONE);
				showthree = false;
			} else {
				mlv_add.setVisibility(View.VISIBLE);
				showthree = true;
			}
			break;
