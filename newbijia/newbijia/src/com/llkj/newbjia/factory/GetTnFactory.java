...
public class GetTnFactory {
	public static Bundle parseResult(String wsResponse) throws JSONException {
		...
		if (jsonObject.has(ResponseBean.RESPONSE_TN)) {
			bundle.putString(ResponseBean.RESPONSE_TN,
					jsonObject.getString(ResponseBean.RESPONSE_TN));
		}
