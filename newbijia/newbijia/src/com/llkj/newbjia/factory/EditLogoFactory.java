...
public class EditLogoFactory {
	public static Bundle parseResult(String wsResponse) throws JSONException {
		...
		if (jsonObject.has(ResponseBean.RESPONSE_LOGO_ID)) {
			bundle.putString(ResponseBean.RESPONSE_LOGO_ID,
					jsonObject.getString(ResponseBean.RESPONSE_LOGO_ID));
		}
