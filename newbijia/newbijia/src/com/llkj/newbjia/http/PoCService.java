...
public class PoCService extends WorkerService {
	...
	public static final int TYPE_INDEX_ZITIDISTRIBUTION = 0x100;
	...
	public static final int TYPE_INDEX_EDITLOGO = 0x73;

	public static final int TYPE_INDEX_EDITNUMBER = 0x72;

	public static final int TYPE_INDEX_SHOPCARTDEL = 0x71;

	public static final int TYPE_INDEX_PURCHASEBUY = 0x70;

	public static final int TYPE_INDEX_GETTN = 0x69;

	public static final int TYPE_INDEX_ALIPAYAFFIRM = 0x68;

	public static final int TYPE_INDEX_SUBMITORDER = 0x67;

	public static final int TYPE_INDEX_VERIFYGOOD = 0x66;

	public static final int TYPE_INDEX_ZITISEARCH = 0x65;

	public static final int TYPE_INDEX_MYORDER = 0x64;

	public static final int TYPE_INDEX_ORDERDESC = 0x63;

	public static final int TYPE_INDEX_BROWSELIST = 0x62;

	public static final int TYPE_INDEX_HELPLIST = 0x61;

	public static final int TYPE_INDEX_VERSION = 0x60;
	public static final int TYPE_INDEX_CANCELORDER = 0x59;
	public static final int TYPE_INDEX_GETGROUPPRICE = 0x58;

	public static final int TYPE_INDEX_APPPERSON_COMMUNITYLIST = 0x57;
	public static final int TYPE_INDEX_APPPERSON_CITYLIST = 0x56;

	public static final int TYPE_INDEX_DELCIRCLE = 0x55;
	public static final int TYPE_INDEX_FRIENDDEL = 0x54;
